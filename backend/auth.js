...
const firebaseConfig = {
  ...
  projectId: process.env.FIREBASE_PROJECT_ID || window.FIREBASE_CONFIG?.projectId,
  storageBucket: process.env.FIREBASE_STORAGE_BUCKET || window.FIREBASE_CONFIG?.storageBucket,
  messagingSenderId: process.env.FIREBASE_MESSAGING_SENDER_ID || window.FIREBASE_CONFIG?.messagingSenderId,
  appId: process.env.FIREBASE_APP_ID || window.FIREBASE_CONFIG?.appId,
  measurementId: process.env.FIREBASE_MEASUREMENT_ID || window.FIREBASE_CONFIG?.measurementId
};
...
function setupGoogleSignIn() {
    ...
    if (googleBtn) {
        ...
        console.log("⚠️ Google button not found yet, retrying...");
...
function checkAuthState() {
    if (!auth) {
        console.log("⏳ Auth not ready, checking again...");
